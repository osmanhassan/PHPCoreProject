<?php
	...
	$eresult=select_events($_SESSION['myc']);
				...
				<div class="leftpanel">
					...
					<div class="nav" style="height:300px">
						...
						<ul>
							...
							<li style="background-color:green"><a href="client_dashboard.php">Dashboard</a></li>
				...
				<?php
					...
					<div class="profilecard" id="div';?><?=$i?><?='">
						...
						<div class="profileheader">
							...
							<input type="button" id="likeb';?><?=$i?><?php echo '" value="';?><?php $l=checkLikedBefore($row['eid'],$_SESSION['myc'],"client_like");$lr=mysqli_fetch_row($l);if($lr[2]==$_SESSION['myc'])echo "Liked";else echo"Like";?><?php echo'" onclick="like';?><?=$i?><?php echo '()" style="font-size:15px;margin-right:5px;font-weight:bold;color:#fff;background-color:rgba(0,0,0,0.9);width:80px;height:50px;float:right;margin-top:-40px;border-radius:5px"/>
					...
					<script>
						...
						function like';?><?=$i?><?php echo '(){
							...
							var name="';echo $_SESSION["myc"];echo'";
						...
						<script>';?><?php echo'
							...
							function postcomment';?><?=$i?><?='() {
									...
									var name="';?><?php echo $_SESSION["myc"]?><?php echo'";
									var eid="';?><?php echo $row["eid"]?><?php echo'";
