				...
				<div class="leftpanel">
					...
					<div class="nav" style="height:300px">
						...
						<ul>
							...
							<li style="background-color:green"><a href="client_mail.php">Mail</a></li>
				...
				<div class="content" onmouseover="callme()">
					...
					while($row = mysqli_fetch_assoc($eresult)){
						...
						<div onclick="appendMail';echo $i;echo'()" style="width:93%;margin:0 auto;margin-top:10px;background-color:rgba(0,0,0,0.5);color:#fff;border-radius:0 10px 0 10px;padding:10px">
							...
							<img src="';echo $row['eimage']; echo'"  style="margin-right:10px;float:left;height:10%;width:15%;">
							
							<div style="margin-top:-0.5px;padding-left:5px;overflow-X:hide;oveflow-Y:scroll">
								
								<a style="font-size:20px">';echo $row['ename']; echo'</a><br/>
								
								<a style="font-size:15px">Published by : ';echo $row['publisher']; echo'</a><br/>
								
								<a style="font-size:15px">Starts on : ';$stime=strtotime($row['stime']);echo date("d-m-Y h:i A",$stime); echo'</a><br/>
						...
						<script>
							...
							function appendMail';echo $i;echo'(){
								...
								document.getElementById("to").value="';echo $row['publisher'];echo'";
								
								document.getElementById("subject").value="';echo $row['ename'];echo'";
							}
						</script>
